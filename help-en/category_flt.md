...
[**flt.c_apf**](flt.c_apf.html): allpass filter coefficients calculator for \[flt.biquad~\] object <br>
...
[**flt.c_hpf**](flt.c_hpf.html): HPF coefficients calculator for \[flt.biquad~\] <br>
...
[**flt.c_lpf**](flt.c_lpf.html): LPF coefficients calculator for \[flt.biquad~\] <br>
_aliases:_ \[ceammc/lpf-&gt;biquad\], \[lpf-&gt;biquad\]


[**flt.c_lpf\~**](flt.c_lpf~.html): LPF coefficients calculator for \[flt.biquad~\] 

[**flt.c_notch**](flt.c_notch.html): band-reject filter coefficients calculator for \[flt.biquad~\] <br>
...
[**flt.c_pole**](flt.c_pole.html): оne-pole coefficient calculator for \[flt.biquad~\] <br>
