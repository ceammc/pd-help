...
[**array.hist**](array.hist.html): вычисление гистограммы массива <br>
...
[**array.play~**](array.play~.html): проигрывание массива с изменяемой скоростью и амплитудой <br>
...
[**array.readwrite~**](array.readwrite~.html): одновременное чтение/запись сигналов в массив <br>
_псевдонимы:_ \[array.rw~\]


[**array.resample**](array.resample.html): пересемплирование массива <br>
