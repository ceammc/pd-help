...
* **@mode** 
Получить/установить output mode. In bang mode - outputs bang on mouse down. In button mode outputs
1 on mouse down and 0 on mouse up. In toggle mode outputs 1/0 on mouse down,
like vanilla toggle object.<br>
_тип:_ symbol<br>
_варианты:_ bang, button, toggle<br>
_по умолчанию:_ button<br>

* **@enabled** 
Получить/установить enabled property<br>
_тип:_ int<br>
_варианты:_ 0, 1<br>
_по умолчанию:_ 1<br>

* **@icon_size** 
Получить/установить icons size<br>
_тип:_ int<br>
_варианты:_ 18, 24, 36, 48<br>
_по умолчанию:_ 24<br>

* **@icon** 
Получить/установить icon name<br>
_тип:_ symbol<br>
